 ...
 *
 *         static vector < string > active_similarity_names: static member
 *         which stores the names of attributes whose comparison functions are activated.
 *
 ...
 *
 *  vector <unsigned int> record_compare_by_attrib_indice (const Record &rhs,
 ...
 *
 *        const vector <const string * > & get_data_by_index(const unsigned int i) const:
